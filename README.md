...
Tweakings : I added screenshots to better explain concepts, I created a custom dataset on climate change and deforestation, including various causes, impacts, and potential solutions. I then used  Playground along with PromptHub to make a prompt I then added custom examples on it , iterating multiple times to improve its performance and output quality and also ran an experiment over the custom dataset which I had created. 
...
My code : https://github.com/rishitkam/rishitkam-langsmith-mat496/blob/main/Module3/prompt_engineering_lifecycle.ipynb
